...
class Net(nn.Module):
    def __init__(self, hidden_dims=(128,64), augmented=True, num_rawfeatures=11):
        super().__init__()
...
if __name__ == "__main__":
    ...
    # TODO: may not have active learning for Reacher
    ...
    if augmented:
        ...
        if active_learning:
            ...
            if seed == 0:
                al_demos = None
                al_demo_rewards = None
                al_demo_reward_per_timestep = None
            if seed == 1:
                al_demos = None
                al_demo_rewards = None
                al_demo_reward_per_timestep = None
    ...
    device = torch.device("cuda:0" if torch.cuda.is_available() else "cpu")
    reward_net = Net(hidden_dims=hidden_dims, augmented=augmented, num_rawfeatures=num_rawfeatures)
