...
for seed in 0 1 2; do
  ...
  config="feature_sensitivity/${var1}raw_augmentedfull_linear_2000prefs_60pairdelta_100epochs_10patience_001lr_001l1reg"
  ...
  cd trex/
  python3 model.py --augmented_full --num_rawfeatures ${var1} --num_comps 2000 --pair_delta 60 --num_epochs 100 --patience 10 --lr 0.01 --l1_reg 0.01 --seed $seed --reward_model_path $reward_model_path > $reward_output_path
