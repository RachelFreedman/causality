...
for seed in 0 1 2; do
  ...
  config="feature_sensitivity/${var1}raw_augmented_linear_privilegedreward_2000prefs_60pairdelta_100epochs_10patience_001lr_001l1reg"
  ...
  cd trex/
  python3 model.py --augmented --num_rawfeatures ${var1} --privileged_reward --num_comps 2000 --pair_delta 60 --num_epochs 100 --patience 10 --lr 0.01 --l1_reg 0.01 --seed $seed --reward_model_path $reward_model_path > $reward_output_path

  #RL
  echo "Performing RL..."
  cd ..
  policy_save_dir="./trained_models_reward_learning/${config}_seed${seed}"
  python3 mujoco_gym/learn.py --env "ReacherLearnedReward-v0" --algo sac --seed $seed --train --train-timesteps 1000000 --reward-net-path $reward_model_path --save-dir $policy_save_dir
